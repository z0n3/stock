...
stock_tdx_day_line_headers = ['date','open','high','low','close','amount','vol','non']
...
#tdx_fz_line_file = r'C:\new_gxzq_v6.56\vipdoc'
tdx_fz_line_file = r'C:\data\new_zx_allin1\vipdoc'
stock_tdx_day_line_file = '../data/perm/tdxdayline/'
